...
instruments appear exactly when they start to matter. Each has a picture of the
road: the first is the fog itself, the path gone a few steps ahead and gone
behind, with **no warm light anywhere in the frame** — measured, not assumed:
not one pixel is warmer than it is cool. That is what makes the lantern on the
second screen the first warm thing in the game. And that second one is **the
earned road
...
| The fog | The first intro screen | `img/scene-fog.jpg` |
| The light | The second intro screen | `img/scene-light.jpg` |

All ten are 688 × 516 JPEGs (4:3) in the palette above. `normal` and

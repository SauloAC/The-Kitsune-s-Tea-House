...
const TEXT = {
  en: {
    ...
    pages: {
      ...
      gameSceneLight: "The tea house seen from the road at night: a paper lantern burning by the door and the paper windows glowing yellow, with smoke rising from the roof. The traveller, seen from behind in a straw hat and cloak with a staff, climbs the dirt path towards it. White fog fills the valley between dark cedars and blue mountains, under a thin crescent moon.",
      gameSceneFog: "The mountain road at night, swallowed by fog: the dirt path disappears a few steps ahead, and has already disappeared behind. The traveller, seen from behind in a straw hat and cloak with a staff, walks on alone. On either side, pale cedars barely suggested inside the fog, wet grass and loose stones at the edge. There is no house in sight, and no light of any kind.",
      gameChoices: "Choices",
      ...
      howToCandleText: "The candle has six marks. Examining something burns one. When the last mark burns, it's midnight: in the dark, the house writes your name in the book for you.",
      ...
      howToLedgerHeading: "The guest book",
      howToLedgerText: "At the third mark she leaves the room for a moment. That is the only time you can open the guest book: pages and pages of travellers' names, every one of them dated tonight. If you read it, a third choice appears beside the doors at the last mark — to sign.",
      ...
      howToStakesHeading: "What is at stake",
      howToStakesText: "Someone has to keep the hearth lit and pour the tea, and that someone is whoever's name is in the book. While yours is not there, you can still leave by the road. If you stay, you are the one pouring tea for the next traveller — until another writes their own name. And the game takes one difference seriously: a name written of your own will releases the host; a name the house writes for you releases nobody.",
  ...
  pt: {
    ...
    pages: {
      ...
      gameSceneLight: "A casa de chá vista da estrada, à noite: uma lanterna de papel acesa junto à porta e as janelas de papel brilhando em amarelo, com fumaça subindo do telhado. O viajante, visto de costas, de chapéu de palha, capa e bastão, sobe o caminho de terra em direção a ela. A névoa branca preenche o vale, entre cedros escuros e montanhas azuis, sob uma lua fina.",
      gameSceneFog: "A estrada de montanha à noite, engolida pela névoa: o caminho de terra some poucos passos à frente, e atrás já sumiu também. O viajante, visto de costas, de chapéu de palha, capa e bastão, segue sozinho. Dos dois lados, cedros pálidos apenas insinuados dentro da névoa, capim molhado e pedras soltas na borda. Não há casa nenhuma à vista, nem luz de espécie alguma.",
      ...
      howToCandleText: "A vela tem seis marcas. Examinar alguma coisa queima uma. Quando a última marca queima, é meia-noite: no escuro, a casa escreve o seu nome no livro por você.",
      ...
      howToLedgerHeading: "O livro de visitas",
      howToLedgerText: "Na terceira marca ela sai da sala por um instante. É a única altura em que dá para abrir o livro de visitas: páginas e páginas de nomes de viajantes, todos com a data de hoje. Se você o ler, na última marca aparece uma terceira escolha ao lado das portas — assinar.",
      ...
      howToStakesHeading: "O que está em jogo",
      howToStakesText: "Alguém tem de manter a lareira acesa e servir o chá, e quem faz isso é a pessoa cujo nome está no livro. Enquanto o seu não estiver lá, você ainda pode ir embora pela estrada. Se ficar, é você quem serve o chá ao próximo viajante — até que outro escreva o próprio nome. E há uma diferença que o jogo leva a sério: um nome escrito por sua vontade liberta a anfitriã; um nome que a casa escreve por você não liberta ninguém.",
  ...
  es: {
    ...
    pages: {
      ...
      gameSceneLight: "La casa de té vista desde el camino, de noche: un farol de papel encendido junto a la puerta y las ventanas de papel brillando en amarillo, con humo saliendo del tejado. El viajero, visto de espaldas, con sombrero de paja, capa y bastón, sube el sendero de tierra hacia ella. La niebla blanca llena el valle, entre cedros oscuros y montañas azules, bajo una luna fina.",
      gameSceneFog: "El camino de montaña de noche, tragado por la niebla: el sendero de tierra desaparece unos pasos más adelante, y por detrás ya ha desaparecido también. El viajero, visto de espaldas, con sombrero de paja, capa y bastón, sigue solo. A ambos lados, cedros pálidos apenas insinuados dentro de la niebla, hierba mojada y piedras sueltas en el borde. No hay ninguna casa a la vista, ni luz de ninguna clase.",
      ...
      howToCandleText: "La vela tiene seis marcas. Examinar algo quema una. Cuando se quema la última, es medianoche: en la oscuridad, la casa escribe tu nombre en el libro por ti.",
      ...
      howToLedgerHeading: "El libro de visitas",
      howToLedgerText: "En la tercera marca ella sale de la sala un momento. Es la única ocasión en que puedes abrir el libro de visitas: páginas y páginas de nombres de viajeros, todos con la fecha de hoy. Si lo lees, en la última marca aparece una tercera opción junto a las puertas: firmar.",
      ...
      howToStakesHeading: "Lo que está en juego",
      howToStakesText: "Alguien tiene que mantener el fuego encendido y servir el té, y ese alguien es la persona cuyo nombre está en el libro. Mientras el tuyo no esté ahí, todavía puedes irte por el camino. Si te quedas, eres tú quien sirve el té al próximo viajero, hasta que otro escriba su propio nombre. Y hay una diferencia que el juego se toma en serio: un nombre escrito por tu propia voluntad libera a la anfitriona; un nombre que la casa escribe por ti no libera a nadie.",
      howToControlsHeading: "Controles",
  ...
  fr: {
    ...
    pages: {
      ...
      gameSceneLight: "La maison de thé vue depuis la route, la nuit\u202F: une lanterne de papier allumée près de la porte et les fenêtres de papier qui brillent en jaune, de la fumée au-dessus du toit. Le voyageur, vu de dos, chapeau de paille, cape et bâton, monte le chemin de terre vers elle. Le brouillard blanc emplit la vallée, entre les cèdres sombres et les montagnes bleues, sous un mince croissant de lune.",
      gameSceneFog: "La route de montagne la nuit, avalée par le brouillard\u202F: le chemin de terre disparaît quelques pas plus loin, et derrière il a déjà disparu aussi. Le voyageur, vu de dos, chapeau de paille, cape et bâton, avance seul. De part et d'autre, des cèdres pâles à peine suggérés dans le brouillard, de l'herbe mouillée et des pierres au bord. Aucune maison en vue, et aucune lumière d'aucune sorte.",
      gameChoices: "Choix",
      ...
      howToCandleText: "La bougie compte six marques. Examiner quelque chose en brûle une. Quand la dernière marque brûle, il est minuit\u202F: dans le noir, la maison écrit votre nom dans le registre à votre place.",
      ...
      howToLedgerHeading: "Le registre",
      howToLedgerText: "À la troisième marque, elle quitte la pièce un instant. C'est le seul moment où vous pouvez ouvrir le registre\u202F: des pages et des pages de noms de voyageurs, tous datés de ce soir. Si vous le lisez, une troisième possibilité apparaît à côté des portes à la dernière marque\u202F: signer.",
      ...
      howToStakesHeading: "Ce qui est en jeu",
      howToStakesText: "Quelqu'un doit garder le foyer allumé et servir le thé, et ce quelqu'un est la personne dont le nom est dans le registre. Tant que le vôtre n'y est pas, vous pouvez encore partir par la route. Si vous restez, c'est vous qui servez le thé au prochain voyageur, jusqu'à ce qu'un autre écrive son propre nom. Et le jeu prend une différence au sérieux\u202F: un nom écrit de votre plein gré libère l'hôtesse\u202F; un nom que la maison écrit à votre place ne libère personne.",
  ...
  ja: {
    ...
    pages: {
      ...
      gameSceneLight: "夜の街道から見た茶屋。戸口では提灯がひとつ灯り、障子窓が黄色く光り、屋根からは煙が上がっている。旅人は後ろ姿で、菅笠をかぶり、蓑をまとい、杖を突いて、土の道をその明かりへと登っていく。白い霧が谷を満たし、暗い杉と青い山々のあいだに広がり、空には細い三日月がかかっている。",
      gameSceneFog: "霧に呑まれた夜の山道。土の道は数歩先で消え、うしろの道もすでに消えている。旅人は後ろ姿で、菅笠をかぶり、蓑をまとい、杖を突いて、ひとり歩いていく。道の両側には、霧の中にかすかに浮かぶ杉の影、濡れた草と小石。家はどこにも見えず、灯りもひとつもない。",
      gameChoices: "選択肢",
      gameClues: "確かな手がかり",
      gameLog: "履歴",
      ...
      howToCandleText: "蝋燭には六つの刻みがあります。何かを調べると、一つ燃えます。最後の刻みが燃えると、真夜中です。暗闇の中で、家があなたの代わりに宿帳へ名を書きます。",
      ...
      howToLedgerHeading: "宿帳",
      howToLedgerText: "三つ目の刻みで、女将は少しのあいだ席を外します。宿帳を開けるのは、そのときだけです。頁をめくると旅人の名がいくつも並び、どれも今日の日付です。読んでおくと、最後の刻みで戸の横に三つ目の選択肢が現れます——署名することです。",
      howToDoorsHeading: "二つの戸",
      howToDoorsText: "最後の刻みには、戸が二つあります。道へ戻れるのは一つだけ。確かめた手がかりが多いほど、見分けやすくなります。",
      howToStakesHeading: "何がかかっているか",
      howToStakesText: "囲炉裏の火を絶やさず、茶を注ぐ者が誰か要ります。それは、宿帳に名のある人です。あなたの名がそこにないあいだは、まだ道を歩いて帰れます。留まれば、次の旅人に茶を注ぐのはあなたです——別の誰かが自分の名を書くまで。そして、この物語が重く見ている違いがあります。自らの意志で書かれた名は女将を解き放ちますが、家があなたの代わりに書いた名は、誰も解き放ちません。",
